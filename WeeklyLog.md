...
They love writing .md files but even better is to ask them to use html files. You can see the skill in my repo [visual-walkthrough](https://github.com/AI-for-engineering-research/prashanth/tree/main/skills/visual-walkthrough) and the full html page [here](https://github.com/AI-for-engineering-research/prashanth/tree/main/assets/evaluation_presentation.html).
